...
export ZSH=/home/sammi/.oh-my-zsh
...
POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(pawprint user dir vcs)
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(status docker nvm node_version public_ip spotify_status)
...
# OPAM configuration
. /home/sammi/.opam/opam-init/init.zsh > /dev/null 2> /dev/null || true
